...
# =========================
# Step 3.5 Define BOARD_IP (STATIC)
# =========================
echo "[3.5/8] Define BOARD_IP"
if [ -z "$BOARD_IP" ]; then
    BOARD_IP="192.168.50.1/24"
    echo "[INFO] BOARD_IP not set, using default: $BOARD_IP"
else
    echo "[INFO] BOARD_IP already set: $BOARD_IP"
fi

export BOARD_IP

# =========================
# Step 4: Netplan (Ad-hoc) (FIX)
# =========================
echo "[4/8] Configuring netplan..."
